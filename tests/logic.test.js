...
const VERBS = {
  ...
  PODER: {
    Indicativo: {
      ...
      "Pretérito Perfeito simples":       ["pude","pudeste","pôde","pudemos","pudestes","puderam"],
      "Pretérito Perfeito composto":      ["tenho podido","tens podido","tem podido","temos podido","tendes podido","têm podido"],
      "Pretérito mais-que-perfeito simples":  ["pudera","puderas","pudera","pudéramos","pudéreis","puderam"],
      "Pretérito mais-que-perfeito composto": ["tinha podido","tinhas podido","tinha podido","tínhamos podido","tínheis podido","tinham podido"],
      "Futuro do Presente simples":       ["poderei","poderás","poderá","poderemos","podereis","poderão"],
      "Futuro do Presente composto":      ["terei podido","terás podido","terá podido","teremos podido","tereis podido","terão podido"],
      "Futuro do Pretérito simples":      ["poderia","poderias","poderia","poderíamos","poderíeis","poderiam"],
      "Futuro do Pretérito composto":     ["teria podido","terias podido","teria podido","teríamos podido","teríeis podido","teriam podido"],
    },
    Subjuntivo: {
      "Presente":                         ["possa","possas","possa","possamos","possais","possam"],
      "Pretérito Perfeito":               ["tenha podido","tenhas podido","tenha podido","tenhamos podido","tenhais podido","tenham podido"],
      "Pretérito Imperfeito":             ["pudesse","pudesses","pudesse","pudéssemos","pudésseis","pudessem"],
      "Pretérito mais-que-perfeito":      ["tivesse podido","tivesses podido","tivesse podido","tivéssemos podido","tivésseis podido","tivessem podido"],
      "Futuro simples":                   ["puder","puderes","puder","pudermos","puderdes","puderem"],
      "Futuro composto":                  ["tiver podido","tiveres podido","tiver podido","tivermos podido","tiverdes podido","tiverem podido"],
    },
    Imperativo: {
      "Afirmativo": ["—","pode (tu)","possa (você)","possamos (nós)","podei (vós)","possam (vocês)"],
      "Negativo":   ["—","não possas (tu)","não possa (você)","não possamos (nós)","não possais (vós)","não possam (vocês)"],
    },
    FormasNominais: {
      "Infinito pessoal": ["poder","poderes","poder","podermos","poderdes","poderem"],
      "Gerúndio":  "podendo",
      "Particípio": "podido",
    },
  },
  ...
  "PÔR": {
    Indicativo: {
      ...
      "Pretérito Perfeito simples":       ["pus","puseste","pôs","pusemos","pusestes","puseram"],
      "Pretérito Perfeito composto":      ["tenho posto","tens posto","tem posto","temos posto","tendes posto","têm posto"],
      "Pretérito mais-que-perfeito simples":  ["pusera","puseras","pusera","puséramos","puséreis","puseram"],
      "Pretérito mais-que-perfeito composto": ["tinha posto","tinhas posto","tinha posto","tínhamos posto","tínheis posto","tinham posto"],
      "Futuro do Presente simples":       ["porei","porás","porá","poremos","poreis","porão"],
      "Futuro do Presente composto":      ["terei posto","terás posto","terá posto","teremos posto","tereis posto","terão posto"],
      "Futuro do Pretérito simples":      ["poria","porias","poria","poríamos","poríeis","poriam"],
      "Futuro do Pretérito composto":     ["teria posto","terias posto","teria posto","teríamos posto","teríeis posto","teriam posto"],
    },
    Subjuntivo: {
      "Presente":                         ["ponha","ponhas","ponha","ponhamos","ponhais","ponham"],
      "Pretérito Perfeito":               ["tenha posto","tenhas posto","tenha posto","tenhamos posto","tenhais posto","tenham posto"],
      "Pretérito Imperfeito":             ["pusesse","pusesses","pusesse","puséssemos","pusésseis","pusessem"],
      "Pretérito mais-que-perfeito":      ["tivesse posto","tivesses posto","tivesse posto","tivéssemos posto","tivésseis posto","tivessem posto"],
      "Futuro simples":                   ["puser","puseres","puser","pusermos","puserdes","puserem"],
      "Futuro composto":                  ["tiver posto","tiveres posto","tiver posto","tivermos posto","tiverdes posto","tiverem posto"],
    },
    Imperativo: {
    ...
    FormasNominais: {
      "Infinito pessoal": ["pôr","pores","pôr","pormos","pordes","porem"],
      "Gerúndio":  "pondo",
      "Particípio": "posto",
    },
  },
  ...
  TRAZER: {
    Indicativo: {
      ...
      "Pretérito Perfeito simples":       ["trouxe","trouxeste","trouxe","trouxemos","trouxestes","trouxeram"],
      "Pretérito Perfeito composto":      ["tenho trazido","tens trazido","tem trazido","temos trazido","tendes trazido","têm trazido"],
      "Pretérito mais-que-perfeito simples":  ["trouxera","trouxeras","trouxera","trouxéramos","trouxéreis","trouxeram"],
      "Pretérito mais-que-perfeito composto": ["tinha trazido","tinhas trazido","tinha trazido","tínhamos trazido","tínheis trazido","tinham trazido"],
      "Futuro do Presente simples":       ["trarei","trarás","trará","traremos","trareis","trarão"],
      "Futuro do Presente composto":      ["terei trazido","terás trazido","terá trazido","teremos trazido","tereis trazido","terão trazido"],
      "Futuro do Pretérito simples":      ["traria","trarias","traria","traríamos","traríeis","trariam"],
      "Futuro do Pretérito composto":     ["teria trazido","terias trazido","teria trazido","teríamos trazido","teríeis trazido","teriam trazido"],
    },
    Subjuntivo: {
      "Presente":                         ["traga","tragas","traga","tragamos","tragais","tragam"],
      "Pretérito Perfeito":               ["tenha trazido","tenhas trazido","tenha trazido","tenhamos trazido","tenhais trazido","tenham trazido"],
      "Pretérito Imperfeito":             ["trouxesse","trouxesses","trouxesse","trouxéssemos","trouxésseis","trouxessem"],
      "Pretérito mais-que-perfeito":      ["tivesse trazido","tivesses trazido","tivesse trazido","tivéssemos trazido","tivésseis trazido","tivessem trazido"],
      "Futuro simples":                   ["trouxer","trouxeres","trouxer","trouxermos","trouxerdes","trouxerem"],
      "Futuro composto":                  ["tiver trazido","tiveres trazido","tiver trazido","tivermos trazido","tiverdes trazido","tiverem trazido"],
    },
    Imperativo: {
    ...
    FormasNominais: {
      "Infinito pessoal": ["trazer","trazeres","trazer","trazermos","trazerdes","trazerem"],
      "Gerúndio":  "trazendo",
      "Particípio": "trazido",
    },
  },
...
const VERB_NAMES = ["SER","IR","ESTAR","TER","FAZER","SABER","QUERER","VIR","VER","DAR","PODER","PÔR","TRAZER"];
